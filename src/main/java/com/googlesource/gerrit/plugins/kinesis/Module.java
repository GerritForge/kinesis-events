...
public class Module extends LifecycleModule {
  ...
  protected void configure() {
    ...
    bind(KinesisAsyncClient.class).toProvider(KinesisAsyncClientProvider.class);
    bind(DynamoDbAsyncClient.class).toProvider(DynamoDbAsyncClientProvider.class);
    bind(CloudWatchAsyncClient.class).toProvider(CloudWatchAsyncClientProvider.class);
